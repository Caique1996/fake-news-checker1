...
return [
    ...
    'paths' => [
        ...
        // Where should DevTools look for operations?
        'operations' => [
            app_path('Http/Controllers/Admin/Operations'),
        ],
    ],
    ...
    // it is up to your core to intepret that file link and actually open the file.
    ...
    // Show links to future features?
    'show_future_features' => false,
