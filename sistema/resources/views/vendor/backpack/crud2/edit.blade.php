...
@section('header')
    <section class="container-fluid">
        <h2>
            ...
            <small>{!! $crud->getSubheading() ?? trans('edit '.$crud->entity_name) !!}.</small>
        ...
        <div class="{{ $crud->getEditContentClass() }}">
            ...
            >
                ...
                @if(view()->exists('vendor.backpack.crud.form_content'))
                    @include('vendor.backpack.crud.form_content', ['fields' => addLabelToFields($crud->fields()), 'action' => 'edit'])
                @else
                    @include('crud::form_content', ['fields' =>addLabelToFields($crud->fields()), 'action' => 'edit'])
                @endif
